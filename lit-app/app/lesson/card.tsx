    ...
    return (
        ...
        >
            ...
            <div className={cn("flex items-center justify-between",
                ...
                {type === "ASSIST" && <div/>}
                <p className={cn("text-slate-600 text-sm lg:text-base",
                ...
                <div className={cn("lg:w-[30px] lg:h-[30px] w-[20px] h-[20px] border-2 flex items-center justify-center rounded-lg text-slate-400 lg:text-[15px] text-xs font-semibold",
